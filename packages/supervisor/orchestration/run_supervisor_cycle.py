...
DAILY_STEPS: tuple[StepDef, ...] = (
    ...
    StepDef('build_scores_v2', 'packages/supervisor/scoring/build_scores_v2.py', requires_healthy=True),
    ...
    StepDef('evaluate_promotion_gate', 'packages/supervisor/policy/promotion_gate.py', requires_healthy=True),
